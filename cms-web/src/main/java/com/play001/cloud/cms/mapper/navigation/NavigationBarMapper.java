package com.play001.cloud.cms.mapper.navigation;
...
public interface NavigationBarMapper {
    ...
    @Results({
            ...
            @Result(column = "navigation_id", property = "navigation", one = @One(select = "com.play001.cloud.cms.mapper.navigation.NavigationMapper.findById"))
    })
