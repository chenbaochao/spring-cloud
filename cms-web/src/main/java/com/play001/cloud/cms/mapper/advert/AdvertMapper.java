...
public interface AdvertMapper {
    ...
    @Results({
            ...
            @Result(column = "section_id",property = "section", one = @One(select = "com.play001.cloud.cms.mapper.section.SectionMapper.findById")),
            @Result(column = "advert_category_id",property = "advertCategory", one = @One(select = "com.play001.cloud.cms.mapper.advert.AdvertCategoryMapper.findById"))
    })
