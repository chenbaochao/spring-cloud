package com.play001.cloud.cms.mapper.section;
...
public interface SectionMapper {
    ...
    @Results({
            ...
            @Result(column = "id", property = "categories", many = @Many(select = "com.play001.cloud.cms.mapper.section.SectionDetailMapper.listBySectionId"))
    })
