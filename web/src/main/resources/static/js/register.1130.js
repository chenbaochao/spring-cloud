/* user-reg/1.0.0 register.1130.js Date:2017-01-19 18:03:20 */
                    ...
                    success: function(response) {
                        if (response) {
                            ...
                            if (obj.info && ("\u77ed\u4fe1\u9a8c\u8bc1\u7801\u4e0d\u6b63\u786e\u6216\u5df2\u8fc7\u671f!" == obj.info ? (console.log("showerror"), showMobileCodeError()) : showDialog(obj.info)), obj.noAuth && (window.location = obj.noAuth), 1 == obj.success) {
                                var ssoHost = ""; - 1 != obj.dispatchUrl.indexOf("localhost") ? ssoHost = "localhost": -1 != obj.dispatchUrl.indexOf("localhost") && (ssoHost = "localhost"),
                                    -1 != obj.dispatchUrl.indexOf("localhost") || -1 != obj.dispatchUrl.indexOf("localhost") ? jQuery.getJSON("//sso.jd.com/setCookie?t=" + ssoHost + "&callback=?",
                                        function() {
